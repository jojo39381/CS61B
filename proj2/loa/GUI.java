...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuRadioButton("Settings->Manual White", "white", false, this::manualWhite);
        addMenuRadioButton("Settings->Manual Black", "black", true, this::manualBlack);
        addMenuRadioButton("Settings->Auto White", "white", true, this::autoWhite);
        addMenuRadioButton("Settings->Auto Black", "black", false, this::autoBlack);
        addMenuButton("Help->About", this::displayAbout);
        addMenuButton("Help->Game play", this::displayHelp);
    ...
    private void displayAbout(String s) {
