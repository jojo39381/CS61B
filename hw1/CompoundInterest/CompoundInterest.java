...
public class CompoundInterest {
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        double inflation = Math.pow((1 - inflationRate / 100), numYears(targetYear));
        return futureValue(presentValue, rate, targetYear) * inflation;
    }
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        double inflation = Math.pow((1 - inflationRate / 100), numYears(targetYear));
        return totalSavings(perYear, targetYear, rate) * inflation;
    }
